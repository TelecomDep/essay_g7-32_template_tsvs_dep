...
\input{1_ascii_coder}                                     % Первая глава
\input{2_error_correction_encoding}                                     % Вторая глава
\input{3_interleaving}
\input{4_x_qam_mapper}
\input{5_ofdm_modulation}
\input{6_channel_model}
\input{7_equalization_ofdm_demodulation}
\input{8_ber}
